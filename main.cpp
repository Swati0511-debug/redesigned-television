...
/*_________________________TIME COMPLEXITIES_________________________

___________________________Channel_dcll_____________________________

bool isEmpty() ---> O(1)
____________________________________________________________________

void create(int ch_no,string ch_name,string ch_genre,float ch_price) ---> O(1)
____________________________________________________________________

void displayAllChannels(int flag) ---> O(n)
____________________________________________________________________

int removeChannel(ChannelNode *chToRemove) ---> O(n)
____________________________________________________________________


_______________________________Stack________________________________

bool isStackEmpty() ---> O(1)
____________________________________________________________________

void push(ChannelNode *n) ---> O(1)
____________________________________________________________________
...
___________________________Menu_operations__________________________

bool Channel_exists(int ch_no,int start,int end)--> O(1)
____________________________________________________________________

ChannelNode *SearchNode(Channel_dcll channellist,int playChannel) ---> O(N)
____________________________________________________________________

Channel_dcll guide_operation(string genre,Channel_dcll ch_list) ---> O(N)
____________________________________________________________________
